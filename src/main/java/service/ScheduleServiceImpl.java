...
//    }
    ...
    public List<ScheduleDTO> findAllTrainAtDateByCities(DateCitiesDTO dateCitiesDTO) {
        List<Pair<Schedule, Schedule>> allTrainAtDateByCities = new ScheduleDAOImpl().findAllTrainAtDateByCities(dateCitiesDTO.getDate(), dateCitiesDTO.getOutCity(), dateCitiesDTO.getInCity());
