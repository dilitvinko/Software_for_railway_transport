...
//
//public class TestClass_2DAO implements CrudDAO<TestClass_2> {
...
//
//    @Override
//    public List<TestClass_2> findAll() {
//        List<TestClass_2> users = new ArrayList<>();
...
//
//    @Override
//    public boolean delete(TestClass_2 entity) {
//        long id = entity.getId();
//        return deleteById(id);
//    }
//
//    @Override
//    public TestClass_2 create(TestClass_2 entity) {
//        boolean flag = false;
...
//
//    @Override
//    public TestClass_2 update(TestClass_2 entity) {
//        try(Connection connection = DriverManager.getConnection(url, user, password);
