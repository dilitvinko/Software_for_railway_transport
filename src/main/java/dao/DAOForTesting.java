...
public class DAOForTesting {
    ...
    public static final String SELECT_FROM_TEST_ENTITY = "SELECT * FROM test_entity";
    public static final String SELECT_FROM_CITY_TIME = "SELECT * FROM city_time";
    private final static String SQL_INSERT ="INSERT INTO city_time(city, time_date) VALUES(?,?)";
