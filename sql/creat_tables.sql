...
-- -----------------------------------------------------
-- Table `software_for_railway_transport`.`test_class_1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `software_for_railway_transport`.`test_class_1` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(255) NOT NULL,
...
-- -----------------------------------------------------
-- Table `software_for_railway_transport`.`test_class_2`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `software_for_railway_transport`.`test_class_2` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `count` INT(11) NOT NULL,
  `numberOrder` INT(11) NOT NULL,
  `id_test_class_1` BIGINT(20) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `test_class_2_test_class_1_id_fk` (`id_test_class_1` ASC) VISIBLE,
  CONSTRAINT `test_class_2_test_class_1_id_fk`
    FOREIGN KEY (`id_test_class_1`)
    REFERENCES `software_for_railway_transport`.`test_class_1` (`id`))
ENGINE = InnoDB
AUTO_INCREMENT = 6
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `software_for_railway_transport`.`ticket` (
  ...
  INDEX `ticket_train_id__fk_idx` (`id_train` ASC) VISIBLE,
